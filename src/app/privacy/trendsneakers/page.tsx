export default function PrivacyPolicy() {
    return (
      <main className="max-w-4xl mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-6">Trendsneakers</h1>
        <br />
        ...
        <section className="space-y-6">
          ...
          <div>
            ...
            <p className="text-gray-700">
              Nuestra aplicación no recopila informacion de los usuarios
            </p>
              <br />
            <h3 className="text-lg font-medium mb-2">2.1 Permisos de la Aplicación</h3>
            <p className="text-gray-700">
              Nuestra aplicación no necesita permisos especiales
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-700">
              ...
              <br />
              Correo electrónico: devlucho.neit@gmail.com
              <br />
              Teléfono: +54 2216497631
            </p>
          </div>
